...
**The Braintree iOS Drop-in SDK permits a deployment target of iOS 12.0 or higher.** It requires Xcode 15.1+ and Swift 5.9+.
...
_This feature is only available in v9. v9.Y.0 requires Xcode 15.1+._
