Pod::Spec.new do |s|
  ...
  s.frameworks = "UIKit"
  s.dependency "Braintree/ApplePay", "~> 5.6"
  s.dependency "Braintree/Card", "~> 5.6"
  s.dependency "Braintree/Core", "~> 5.6"
  s.dependency "Braintree/UnionPay", "~> 5.6"
  s.dependency "Braintree/PayPal", "~> 5.6"
  s.dependency "Braintree/ThreeDSecure", "~> 5.6"
  s.dependency "Braintree/Venmo", "~> 5.6"
  s.resource_bundles = {
