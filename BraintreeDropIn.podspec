Pod::Spec.new do |s|
  ...
  s.subspec "DropIn" do |s|
    ...
    s.frameworks = "UIKit"
    s.dependency "Braintree/ApplePay", "~> 5.0.0-beta2"
    s.dependency "Braintree/Card", "~> 5.0.0-beta2"
    s.dependency "Braintree/Core", "~> 5.0.0-beta2"
    s.dependency "Braintree/UnionPay", "~> 5.0.0-beta2"
    s.dependency "Braintree/PayPal", "~> 5.0.0-beta2"
    s.dependency "Braintree/ThreeDSecure", "~> 5.0.0-beta2"
    s.dependency "Braintree/Venmo", "~> 5.0.0-beta2"
