Pod::Spec.new do |s|
  ...
  s.subspec "DropIn" do |s|
    ...
    s.frameworks = "UIKit"
    s.dependency "Braintree/Card", "~> 4.23"
    s.dependency "Braintree/Core", "~> 4.23"
    s.dependency "Braintree/UnionPay", "~> 4.23"
    s.dependency "Braintree/PaymentFlow", "~> 4.23"
    s.dependency "Braintree/PayPal", "~> 4.23"
